    ...
    _updatePosition() {
        if (this.relative && this.relative.shape) {
            switch (this.fixed) {
                case 'top-left':
                    this.position.set(
                        this.relative.shape.left + this._position.x,
                        this.relative.shape.top + this._position.y
                    );
                    break;
                case 'top-center':
                    this.position.set(
                        this.relative.shape.pivot.x + this._position.x,
                        this.relative.shape.top + this._position.y
                    );
                    break;
                case 'top-right':
                    this.position.set(
                        this.relative.shape.right + this._position.x,
                        this.relative.shape.top + this._position.y
                    );
                    break;
                case 'middle-left':
                    this.position.set(
                        this.relative.shape.left + this._position.x,
                        this.relative.shape.pivot.y + this._position.y
                    );
                    break;
                case 'middle-center':
                    this.position.set(
                ...
                case 'bottom-left':
                    this.position.set(
                        this.relative.shape.left + this._position.x,
                        this.relative.shape.bottom + this._position.y
                    );
                    break;
                case 'bottom-center':
                    this.position.set(
